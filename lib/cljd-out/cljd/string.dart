...
import "string.dart" as UmIcclcoc_string;
...
return (UmIcclcoc_core.$EQ_.$_invoke$2("", UmIcclcoc_string.trim((s$1 as dc.String?), ), ));
}
...
cast$1=(((UmIcclcoc_core.ICounted.extensions(coll7285$1, ) as UmIcclcoc_core.ICounted$ext).$_count$0(coll7285$1, )) as dc.int);
}
final dc.bool $1=(cast$1<2);
if($1){
return ((s$1 as dc.String).toUpperCase());
}
return (UmIcclcoc_core.str.$_invoke$2((UmIcclcoc_core.subs.$_invoke$3((s$1 as dc.String), 0, 1, ).toUpperCase()), (UmIcclcoc_core.subs.$_invoke$2((s$1 as dc.String), 1, ).toLowerCase()), ));
}
...
void f7266$1(dc.dynamic p1$8760_$SHARP_$1, dc.dynamic p2$8759_$SHARP_$1, ){
late final dc.dynamic temp$7105_$AUTO_$1;
if((cmap$1 is dc.Function)){
temp$7105_$AUTO_$1=(cmap$1 as dc.Function)(p2$8759_$SHARP_$1, );
}else if((cmap$1 is UmIcclcoc_core.IFn$iface)){
temp$7105_$AUTO_$1=((cmap$1 as UmIcclcoc_core.IFn$iface).$_invoke$1(p2$8759_$SHARP_$1, ));
}else{
temp$7105_$AUTO_$1=(UmIcclcoc_core.IFn.extensions(cmap$1, ).$_invoke$1(cmap$1, p2$8759_$SHARP_$1, ));
}
late final dc.dynamic $if_$1;
if(((temp$7105_$AUTO_$1!=false)&&(temp$7105_$AUTO_$1!=null))){
final dc.dynamic replacement$1=temp$7105_$AUTO_$1;
$if_$1=(UmIcclcoc_core.str.$_invoke$1(replacement$1, ));
}else{
$if_$1=p2$8759_$SHARP_$1;
}
return (sb$1.write($if_$1, ));
}
final dc.Null start7267$1=null;
if((coll7265$1 is UmIcclcoc_core.IReduce$iface)){
(coll7265$1 as UmIcclcoc_core.IReduce$iface).$_reduce$2(f7266$1, start7267$1, );
}else{
(UmIcclcoc_core.IReduce.extensions(coll7265$1, ) as UmIcclcoc_core.IReduce$ext).$_reduce$2(coll7265$1, f7266$1, start7267$1, );
}
...
// BEGIN index-of
UmIcclcoc_core.IFn$iface index_of=UmIcclcoc_string.index_of$ifn(null, );

// END index-of

// BEGIN index_of$ifn
class index_of$ifn extends dc.Object with UmIcclcoc_core.IFnMixin_uuXX implements UmIcclcoc_core.IMeta$iface, UmIcclcoc_core.IWithMeta$iface, UmIcclcoc_core.Fn$iface, UmIcclcoc_core.IFn$iface {
final meta$1;
...
return UmIcclcoc_string.index_of$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}
...
// BEGIN join
UmIcclcoc_core.IFn$iface join=UmIcclcoc_string.join$ifn(null, );

// END join

// BEGIN join$ifn
class join$ifn extends dc.Object with UmIcclcoc_core.IFnMixin_uXX implements UmIcclcoc_core.IMeta$iface, UmIcclcoc_core.IWithMeta$iface, UmIcclcoc_core.Fn$iface, UmIcclcoc_core.IFn$iface {
final meta$1;
...
dc.dynamic $_with_meta$1(dc.dynamic m$2054_$AUTO_$1, ){
return UmIcclcoc_string.join$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}

dc.dynamic $_invoke$1(dc.dynamic coll$1, ){
return (UmIcclcoc_core.apply.$_invoke$2(UmIcclcoc_core.str, coll$1, ));
}

dc.dynamic $_invoke$2(dc.dynamic separator$1, dc.dynamic coll$2, ){
return ((UmIcclcoc_core.map.$_invoke$2(UmIcclcoc_core.str, coll$2, ) as dc.Iterable).join((separator$1 as dc.String), ));
}
...
// BEGIN last-index-of
UmIcclcoc_core.IFn$iface last_index_of=UmIcclcoc_string.last_index_of$ifn(null, );

// END last-index-of

// BEGIN last_index_of$ifn
class last_index_of$ifn extends dc.Object with UmIcclcoc_core.IFnMixin_uuXX implements UmIcclcoc_core.IMeta$iface, UmIcclcoc_core.IWithMeta$iface, UmIcclcoc_core.Fn$iface, UmIcclcoc_core.IFn$iface {
final meta$1;
...
dc.dynamic $_with_meta$1(dc.dynamic m$2054_$AUTO_$1, ){
return UmIcclcoc_string.last_index_of$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}
...
return (UmIcclcoc_core.str.$_invoke$2("\\", ((m$1 as dc.Match).group(0, )), ));
}, ));
}
...
final dc.dynamic replacement$2=UmIcclcoc_string.replacer(replacement$1, );
...
if((maybe_f$1 is UmIcclcoc_core.IFn$iface)){
return ((maybe_f$1 as UmIcclcoc_core.IFn$iface).$_invoke$1($1, ));
}
return (UmIcclcoc_core.IFn.extensions(maybe_f$1, ).$_invoke$1(maybe_f$1, $1, ));
};
}
return ((s$1 as dc.String).replaceAllMapped(arg$1, wrapper_f$1, ));
}
throw dc.ArgumentError((UmIcclcoc_core.str.$_invoke$2("Invalid match arg: ", match$1, )), );
}
...
dc.dynamic vs$1=UmIcclcoc_core.$_EMPTY_VECTOR;
dc.dynamic i$1=0;
do {
...
final dc.bool and$7082_$AUTO_$1=(UmIcclcoc_core.$EQ_.$_invoke$2(1, cast$1, ));
late final dc.bool $if_$1;
if(and$7082_$AUTO_$1){
$if_$1=(UmIcclcoc_core.peek(vs$1, ) is dc.String);
}else{
$if_$1=and$7082_$AUTO_$1;
}
if($if_$1){
return UmIcclcoc_core.peek(vs$1, );
}
return (dc.dynamic m$1, ){
final dc.StringBuffer sb$1=dc.StringBuffer();
final dc.dynamic coll7265$1=vs$1;
void f7266$1(dc.dynamic p1$8751_$SHARP_$1, dc.dynamic p2$8750_$SHARP_$1, ){
late final dc.dynamic $if_$2;
if((p2$8750_$SHARP_$1 is dc.String)){
$if_$2=p2$8750_$SHARP_$1;
}else{
$if_$2=((m$1 as dc.Match).group((p2$8750_$SHARP_$1 as dc.int), ));
}
...
(UmIcclcoc_core.IReduce.extensions((coll7265$1 as dc.dynamic), ) as UmIcclcoc_core.IReduce$ext).$_reduce$2((coll7265$1 as dc.dynamic), f7266$1, start7267$1, );
}
return (sb$1.toString());
};
}else{
...
o7251$1=UmIcclcoc_string.re_unquote_replacement(r$1, );
}
if((coll7250$1 is UmIcclcoc_core.ICollection$iface)){
vs$1=((coll7250$1 as UmIcclcoc_core.ICollection$iface).$_conj$1(o7251$1, ));
}else{
vs$1=((UmIcclcoc_core.ICollection.extensions((coll7250$1 as dc.dynamic), ) as UmIcclcoc_core.ICollection$ext).$_conj$1((coll7250$1 as dc.dynamic), o7251$1, ));
}
...
final dc.dynamic arg$1=UmIcclcoc_core.re_groups((m$3 as dc.Match), );
late final dc.dynamic $if_$3;
if((replacement$1 is dc.Function)){
$if_$3=(replacement$1 as dc.Function)(arg$1, );
}else if((replacement$1 is UmIcclcoc_core.IFn$iface)){
$if_$3=((replacement$1 as UmIcclcoc_core.IFn$iface).$_invoke$1(arg$1, ));
}else{
$if_$3=(UmIcclcoc_core.IFn.extensions(replacement$1, ).$_invoke$1(replacement$1, arg$1, ));
}
...
// BEGIN split
UmIcclcoc_core.IFn$iface split=UmIcclcoc_string.split$ifn(null, );

// END split

// BEGIN split$ifn
class split$ifn extends dc.Object with UmIcclcoc_core.IFnMixin_uuXX implements UmIcclcoc_core.IMeta$iface, UmIcclcoc_core.IWithMeta$iface, UmIcclcoc_core.Fn$iface, UmIcclcoc_core.IFn$iface {
final meta$1;
...
dc.dynamic $_with_meta$1(dc.dynamic m$2054_$AUTO_$1, ){
return UmIcclcoc_string.split$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}

dc.dynamic $_invoke$2(dc.dynamic s$1, dc.dynamic re$1, ){
final dc.String s$2=(s$1 as dc.String);
return UmIcclcoc_core.vec((s$2.split((re$1 as dc.Pattern), )), );
}
...
return (UmIcclcoc_string.split.$_invoke$2(s$4, re$3, ));
}
dc.dynamic v$1=UmIcclcoc_core.transient(UmIcclcoc_core.$_EMPTY_VECTOR, );
dc.dynamic i$1=0;
final dc.dynamic o7205$1=(UmIcclcoc_core.take.$_invoke$2(((limit$1 as dc.num)-1), (re$3.allMatches(s$4, )), ));
dc.dynamic matches$1;
if((o7205$1 is UmIcclcoc_core.ISeqable$iface)){
matches$1=((o7205$1 as UmIcclcoc_core.ISeqable$iface).$_seq$0());
}else{
matches$1=((UmIcclcoc_core.ISeqable.extensions((o7205$1 as dc.dynamic), ) as UmIcclcoc_core.ISeqable$ext).$_seq$0((o7205$1 as dc.dynamic), ));
}
do {
final dc.dynamic temp$7095_$AUTO_$1=matches$1;
if((null==(temp$7095_$AUTO_$1 as dc.dynamic))){
return UmIcclcoc_core.persistent$BANG_((UmIcclcoc_core.conj$BANG_.$_invoke$2(v$1, (UmIcclcoc_core.subs.$_invoke$2(s$4, i$1, )), )), );
}
final dc.dynamic vec$8756_$1=temp$7095_$AUTO_$1;
final dc.dynamic o7205$2=vec$8756_$1;
late final dc.dynamic seq$8757_$1;
if((o7205$2 is UmIcclcoc_core.ISeqable$iface)){
seq$8757_$1=((o7205$2 as UmIcclcoc_core.ISeqable$iface).$_seq$0());
}else{
seq$8757_$1=((UmIcclcoc_core.ISeqable.extensions((o7205$2 as dc.dynamic), ) as UmIcclcoc_core.ISeqable$ext).$_seq$0((o7205$2 as dc.dynamic), ));
}
final dc.dynamic first$8758_$1=UmIcclcoc_core.first(seq$8757_$1, );
final dc.dynamic seq$8757_$2=UmIcclcoc_core.next(seq$8757_$1, );
final dc.Match m$1=(first$8758_$1 as dc.Match);
final dc.dynamic matches$2=seq$8757_$2;
v$1=(UmIcclcoc_core.conj$BANG_.$_invoke$2(v$1, (UmIcclcoc_core.subs.$_invoke$3(s$4, i$1, m$1.start, )), ));
i$1=m$1.end;
matches$1=matches$2;
continue;
} while(true);
...
return (UmIcclcoc_string.split.$_invoke$2(s$1, dc.RegExp("\\r?\\n", ), ));
}
...
final dc.bool or$7123_$AUTO_$1=(UmIcclcoc_core.$EQ_.$_invoke$2(ch$1, "\n", ));
late final dc.bool $if_$1;
if(or$7123_$AUTO_$1){
$if_$1=or$7123_$AUTO_$1;
}else{
$if_$1=(UmIcclcoc_core.$EQ_.$_invoke$2(ch$1, "\r", ));
}
if($if_$1){
